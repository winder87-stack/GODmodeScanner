...
4. Save to cache and TimescaleDB
...
class WalletProfilerAgent:
    ...
    async def profile_wallet(
        ...
        This method implements the 4-step profiling pipeline:
        ...
        try:
            ...
            # STEP 4: Save to cache and Postgres
    ...
    async def test_wallet_profiler():
        ...
        try:
            ...
            for wallet, profile in profiles.items():
                print(f"  {wallet}: {profile.severity} (score: {profile.risk_score:.3f})")
        except Exception as e:
            print(f"Error: {e}")
