...
if __name__ == "__main__":
    ...
    def create_consumer_group(self, stream: str, group_name: str, id: str = "0") -> bool:
    ...
    async def initialize(self):
        ...
        logger.info("redis_cluster_initialized", mode="cluster" if self.cluster_mode else "standalone")
        self._update_cluster_metrics()
        return self
